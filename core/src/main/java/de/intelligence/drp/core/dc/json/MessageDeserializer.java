...
public final class MessageDeserializer implements JsonDeserializer<Message> {
    ...
    public Message deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
        ...
        final InternalEventType evt = obj.has("evt") && !obj.get("evt").isJsonNull() ? Enums.getIfPresent(InternalEventType.class, obj.get("evt").getAsString()).toJavaUtil().orElse(InternalEventType.INVALID) : null;
